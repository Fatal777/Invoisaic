...
export const ProductCard: React.FC<ProductCardProps> = ({ 
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -5 }}
      className="bg-gray-950 border border-gray-800 rounded-xl overflow-hidden hover:border-red-600 transition-all duration-300 group"
    >
      {/* Product Image */}
      <div className="relative h-48 bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center">
        ...
        <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
          <button className="p-2 bg-black/80 hover:bg-red-600 rounded-lg transition-colors">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="ml-auto p-2 hover:bg-red-600 rounded transition-colors"
            >
...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ 
  ...
  return (
    <Loader2 className={`animate-spin text-red-600 ${sizeClasses[size]} ${className}`} />
  );
};
