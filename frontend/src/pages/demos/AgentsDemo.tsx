      ...
      <div className="border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className={`w-2 h-2 rounded-full ${running ? 'bg-red-600 animate-pulse' : 'bg-gray-700'}`} />
          ...
          <div className="space-y-6">
            ...
            <div className="border border-gray-800 bg-gray-950 p-6">
              ...
              <button
                ...
                className="w-full p-4 border border-gray-700 hover:border-red-600 bg-black rounded text-left transition-colors group"
              >
                <div className="flex items-center gap-3">
                  <Upload className="w-5 h-5 text-gray-600 group-hover:text-red-600 transition-colors" />
