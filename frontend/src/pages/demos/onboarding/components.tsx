...
export const InvoicePreview: React.FC<InvoicePreviewProps> = ({ invoice, onDownload }) => {
  return (
    <motion.div
    ...
    >
          ...
          <div className="space-y-2 text-sm">
            ...
            {invoice.roundOff !== 0 && (
              <div className="flex justify-between">
                ...
                <span className="font-semibold">₹{invoice.roundOff.toFixed(2)}</span>
              </div>
            )}
      ...
      {onDownload && (
        <div className="mt-8 pt-6 border-t border-gray-300">
          <button
            onClick={onDownload}
            className="w-full px-6 py-4 bg-red-600 hover:bg-red-700 text-white rounded-lg font-bold transition-colors flex items-center justify-center gap-2"
          >
