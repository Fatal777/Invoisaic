          ...
          <div className="space-y-6">
            <Card className="bg-white/5 backdrop-blur-xl border-white/10">
              ...
              <CardContent>
                <div className="space-y-6">
                  {/* Autonomous Agent */}
                  <div className="bg-gradient-to-r from-red-900/20 to-purple-900/20 border border-red-500/30 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
                    ...
                    <div className="space-y-4">
                      <div className="grid md:grid-cols-5 gap-2">
                        <div className="bg-red-500/20 text-white px-3 py-2 rounded-lg text-center text-sm">
                          Detects Purchase
                        </div>
                        <ArrowRight className="h-5 w-5 text-red-400 mx-auto my-auto" />
...
→ NO code deployment needed!`}
                  ...
                  <div className="bg-gradient-to-r from-pink-900/20 to-red-900/20 border border-pink-500/30 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
