...
import {
  ...
  Zap, Brain, Sparkles, ArrowRight, Play, Star, Mail
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative overflow-hidden py-16 lg:py-24">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-red-500/5 to-orange-500/5 rounded-full blur-3xl" />
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center relative">
            {/* Glassmorphic Badge */}
            <div className="inline-flex items-center gap-2 mb-8 px-5 py-3 rounded-full border border-white/10 bg-white/5 backdrop-blur-xl">
              <div className="w-1.5 h-1.5 bg-red-500 rounded-full animate-pulse" />
              <span className="text-sm text-gray-400 uppercase tracking-wider font-medium">Powered by Amazon Bedrock Nova Micro</span>
            </div>
            
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-logo font-bold mb-8 leading-none tracking-tight text-white drop-shadow-2xl">
              AI Invoice
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              <Link to="/demo">
                <button className="bg-red-600 hover:bg-red-700 text-white px-10 py-4 rounded-full text-lg font-medium transition-all hover:scale-105 flex items-center gap-2">
                  <Play className="h-5 w-5" />
                  Live Demo
                </button>
              </Link>
              <Link to="/features">
                <button className="border-2 border-white/20 hover:border-white/40 text-white px-10 py-4 rounded-full text-lg font-medium transition-all hover:scale-105 flex items-center gap-2">
                  Explore Features
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {stats.map((stat, idx) => (
                <div key={idx} className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-br from-red-500/20 to-pink-500/20 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
                  <div className="relative border border-white/10 bg-white/5 backdrop-blur-xl rounded-3xl p-8 hover:bg-white/10 hover:-translate-y-1 transition-all">
                    <div className="text-5xl font-bold mb-3 text-white group-hover:text-red-500 transition-colors">{stat.value}</div>
                ...
                return (
                  <div key={i} className="flex items-center gap-3">
                    <div className={`w-3 h-3 rounded-full transition-all duration-300 ${
                      isPassed ? 'bg-red-500 scale-75' : 
                      isActive ? 'bg-red-500 scale-125 shadow-lg shadow-red-500/50' : 
                      'bg-white/20'
                    }`} />
      ...
      <section id="features" className="py-32 bg-zinc-950 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 relative">
            <div className="inline-flex items-center gap-2 mb-6 px-5 py-3 rounded-full border border-white/10 bg-white/5 backdrop-blur-xl">
              <Brain className="h-4 w-4 text-red-500" />
              <span className="text-sm text-gray-400 uppercase tracking-wider font-medium">AI Features</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 relative">
            {features.map((feature, idx) => {
              ...
              return (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 to-orange-500/10 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
                  <div className="relative h-full flex flex-col p-8 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl hover:bg-white/10 hover:border-red-500/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-red-500/20 min-h-[280px]">
                    <div className="w-14 h-14 border border-white/10 rounded-2xl flex items-center justify-center mb-6 group-hover:border-red-500 group-hover:bg-red-500/10 group-hover:scale-110 transition-all flex-shrink-0">
                      <Icon className="h-7 w-7 text-gray-400 group-hover:text-red-500 transition-colors" />
                    </div>
                    <h3 className="text-xl font-bold mb-3 text-white flex-shrink-0">{feature.title}</h3>
          ...
          <div className="text-center mt-16">
            <Link to="/features">
              <button className="bg-red-600 hover:bg-red-700 text-white px-10 py-4 rounded-full text-lg font-medium transition-all hover:scale-105 inline-flex items-center gap-2">
                Try All Features
                <ArrowRight className="h-5 w-5" />
              </button>
            </Link>
      ...
      {/* Demo CTA Section - Red accent on black */}
      <section id="demo" className="py-32 bg-red-600 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <p className="text-xl text-red-100 mb-12 max-w-2xl mx-auto font-light">
      ...
      {/* How It Works - MATTE WHITE SECTION */}
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div key={idx} className="group relative">
                <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 to-pink-500/10 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
                <div className="relative bg-white border border-gray-200 rounded-3xl p-8 hover:shadow-2xl transition-all hover:-translate-y-1">
                  <div className="text-7xl font-bold text-red-600 mb-6 opacity-50 group-hover:opacity-100 transition-opacity">
                    {step.step}
                  </div>
      ...
      <section id="tech" className="py-32 bg-zinc-950 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
          <h2 className="text-4xl md:text-6xl font-bold text-white text-center mb-4">
            Built with AWS
          </h2>
          <p className="text-center text-gray-400 text-lg">Powered by world-class cloud services</p>
        </div>
            ...
            {[...Array(2)].map((_, setIdx) => (
              <div key={setIdx} className="flex gap-6 flex-shrink-0">
                {[
                  ...
                  { name: 'AWS Lambda', desc: 'Serverless Computing', color: 'from-orange-500 to-red-500', icon: Zap },
                  ...
                  { name: 'AWS CDK', desc: 'Infrastructure as Code', color: 'from-yellow-500 to-orange-500', icon: Sparkles },
                ].map((service, idx) => (
                  <div
                    key={idx}
                  ...
                  >
                    <div className="relative h-[200px]">
                      ...
                      {/* Card */}
                      <div className="relative h-full bg-gradient-to-br from-zinc-900 to-black backdrop-blur-xl border border-white/20 rounded-3xl p-6 hover:border-white/40 transition-all group-hover:-translate-y-2 shadow-2xl flex flex-col justify-between">
                        <div>
      ...
      <section className="py-32 bg-gradient-to-br from-gray-900 via-black to-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link to="/demo">
              <button className="bg-red-600 hover:bg-red-700 text-white px-12 py-4 rounded-full text-lg font-medium transition-all hover:scale-105">
                Try Demo Now
              </button>
            </Link>
            <Link to="/features">
      ...
      <section className="py-20 bg-zinc-950 border-y border-white/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-red-500 to-red-600 mb-6">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white px-8 py-4 rounded-full font-medium transition-all hover:scale-105 whitespace-nowrap shadow-lg shadow-red-500/30"
            >
              Subscribe
            </button>
          </form>
