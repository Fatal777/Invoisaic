    ...
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <section className={`relative overflow-hidden py-16 lg:py-24 transition-colors duration-300 ${
        ...
        <div className="absolute inset-0">
          {theme === 'dark' ? (
            <>
              <div className="absolute top-20 right-20 w-96 h-96 bg-gradient-to-br from-orange-900/15 to-zinc-900/10 rounded-full blur-3xl animate-pulse" />
              <div className="absolute bottom-20 left-20 w-96 h-96 bg-gradient-to-br from-zinc-800/10 to-black/5 rounded-full blur-3xl" />
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-orange-950/8 to-zinc-900/5 rounded-full blur-3xl" />
            </>
          ) : (
            <>
              <div className="absolute top-20 right-20 w-96 h-96 bg-gradient-to-br from-orange-100/30 to-gray-100/30 rounded-full blur-3xl animate-pulse" />
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-orange-50/30 to-gray-100/20 rounded-full blur-3xl" />
            </>
          )}
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center relative">
            ...
            <h1 className={`text-6xl md:text-8xl lg:text-9xl font-logo font-bold mb-8 leading-none tracking-tight transition-colors ${
              ...
              AI Invoice
              <br />
              <span className={theme === 'dark' ? 'text-orange-500' : 'text-orange-600'}>
                Automation
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              <Link to="/demo">
                <button className="bg-orange-600 hover:bg-orange-700 text-white px-10 py-4 rounded-full text-lg font-medium transition-all hover:scale-105 flex items-center gap-2 shadow-lg shadow-orange-500/30">
              ...
              {stats.map((stat, idx) => (
                <div key={idx} className="relative group">
                  ...
                  <div className={`relative border-2 rounded-3xl p-8 hover:-translate-y-1 transition-all shadow-lg ${
                    theme === 'dark'
                      ? 'border-zinc-800 bg-zinc-950 hover:border-orange-600'
      ...
      <section id="features" className={`py-32 relative overflow-hidden transition-colors ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              return (
                ...
                >
                  ...
                  <div className={`relative h-full flex flex-col p-8 border-2 rounded-3xl transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl min-h-[280px] ${
                    theme === 'dark'
                      ? 'bg-zinc-900 border-zinc-800 hover:bg-zinc-900/80 hover:border-orange-600 hover:shadow-orange-900/20'
                      : 'bg-gray-50 border-gray-200 hover:bg-white hover:border-orange-300 hover:shadow-orange-500/20'
                  }`}>
                    <div className={`w-14 h-14 border-2 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-all flex-shrink-0 ${
                      theme === 'dark'
                        ? 'border-zinc-700 group-hover:border-orange-500 group-hover:bg-orange-950'
                        : 'border-gray-300 group-hover:border-orange-500 group-hover:bg-orange-50'
                    }`}>
          ...
          <div className="text-center mt-16">
            <Link to="/features">
              <button className="bg-orange-600 hover:bg-orange-700 text-white px-10 py-4 rounded-full text-lg font-medium transition-all hover:scale-105 inline-flex items-center gap-2 shadow-lg shadow-orange-500/30">
                Try All Features
                <ArrowRight className="h-5 w-5" />
              </button>
            </Link>
      ...
      {/* Demo CTA Section */}
      <section id="demo" className="py-32 bg-orange-600 relative overflow-hidden transition-colors">
            ...
            {[...Array(2)].map((_, setIdx) => (
              <div key={setIdx} className="flex gap-6 flex-shrink-0">
                {[
                  ...
                  { name: 'AWS Lambda', desc: 'Serverless Computing', color: 'from-orange-500 to-[#EFA498]', icon: Zap },
      ...
      <section className="py-32 bg-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link to="/demo">
              <button className="bg-orange-600 hover:bg-orange-700 text-white px-12 py-4 rounded-full text-lg font-medium transition-all hover:scale-105 shadow-lg shadow-orange-500/30">
                Try Demo Now
              </button>
            </Link>
            <Link to="/features">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
            <input
              ...
              className="flex-1 px-6 py-4 bg-white/5 border border-white/10 rounded-full text-white placeholder-gray-500 focus:outline-none focus:border-orange-500 focus:bg-white/10 transition-all"
            />
            <button
              type="submit"
              className="bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-700 hover:to-orange-600 text-white px-8 py-4 rounded-full font-medium transition-all hover:scale-105 whitespace-nowrap shadow-lg shadow-orange-500/30"
            >
              Subscribe
            </button>
          </form>
