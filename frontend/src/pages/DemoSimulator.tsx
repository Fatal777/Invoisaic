    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-8">
        ...
        <div className="text-center mb-12">
          <Badge className="bg-gradient-to-r from-red-600 to-red-500 text-white text-sm px-4 py-2 mb-4">
            🤖 Agentic AI System
          </Badge>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                {agentPhases.map((phase, idx) => (
                  <div key={idx} className={`p-3 rounded-lg border ${
                    ...
                    idx === currentPhase ? 'bg-red-500/20 border-red-500/50 text-red-400 animate-pulse' :
            ...
            <CardContent>
              <div className="grid md:grid-cols-4 gap-4">
                ...
                <div className="text-center">
                  ...
                  <div className={`text-xl font-bold ${(marketAnalysis?.variance || 0) > 0 ? 'text-red-400' : 'text-green-400'}`}>
                ...
                <div className="text-center">
                  ...
                  <div className={`text-sm font-bold ${
                    ...
                    marketAnalysis?.recommendation === 'OVERPRICED' ? 'text-red-400' : 'text-yellow-400'
                  }`}>
              ...
              <div className="space-y-3">
                {detectedAnomalies.map((anomaly, idx) => (
                  <div key={idx} className={`p-4 rounded-lg border ${
                    anomaly.severity === 'HIGH' ? 'bg-red-500/20 border-red-500/50' :
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className={`text-xs ${
                        anomaly.severity === 'HIGH' ? 'bg-red-600' : 'bg-yellow-600'
                      }`}>
                        {anomaly.severity}
                      </Badge>
                    </div>
        ...
        <div className="text-center">
          <Button
            ...
            className="bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white px-8 py-4 text-lg font-medium transition-all hover:scale-105 shadow-lg shadow-red-500/30"
          >
            {processing ? (
              <>
