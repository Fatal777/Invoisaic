  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-8">
        ...
        {/* Features Banner */}
        <Card className="bg-gradient-to-br from-red-500/10 to-red-600/10 backdrop-blur-xl border-red-500/30 mb-8">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-4">
                        {/* File Preview/Icon */}
                        <div className="w-16 h-16 rounded-lg bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center flex-shrink-0 overflow-hidden">
