...
Write-Host "`nStep 2: Enabling versioning..." -ForegroundColor Green
...
Write-Host "`nStep 3: Uploading compliance documents..." -ForegroundColor Green
...
Write-Host "`nStep 4: Verifying uploads..." -ForegroundColor Green
